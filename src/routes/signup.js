    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                if (usernameExists) {
                    return [2 /*return*/, res.status(400).json({ error: "Veuillez choisir un autre nom d'utilisateur" })];
                }
            ...
            case 2:
                ...
                res.json({ message: "Utilisateur ".concat(username, " cr\u00E9\u00E9 !"), token: token });
                return [3 /*break*/, 4];
            case 3:
                err_1 = _b.sent();
                console.error("Failed to create user:", err_1);
                res.status(500).json({ error: "Failed to create user ==> ".concat(err_1.message) });
                return [3 /*break*/, 4];
